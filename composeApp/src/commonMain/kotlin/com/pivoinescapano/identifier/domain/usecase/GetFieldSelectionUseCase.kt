...
class GetFieldSelectionUseCase(
    ...
    suspend fun getAvailableRangs(champ: String, parcelle: String): List<String> {
        return fieldRepository.getDistinctRangs(champ, parcelle)
    }
    
    suspend fun getAvailableTrous(champ: String, parcelle: String, rang: String): List<String> {
